...
require_once ROOT . 'libs/oss/Core/MimeTypes.php';
require_once ROOT . 'libs/oss/Core/OssException.php';
require_once ROOT . 'libs/oss/Core/OssUtil.php';

require_once ROOT . 'libs/oss/Http/RequestCore.php';
require_once ROOT . 'libs/oss/Http/RequestCore_Exception.php';
require_once ROOT . 'libs/oss/Http/ResponseCore.php';

require_once ROOT . 'libs/oss/Result/PutSetDeleteResult.php';
require_once ROOT . 'libs/oss/Result/BodyResult.php';
